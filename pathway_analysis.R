...
#pathways_to_analyse <- read.table(file.path(pathway_dir, 'pathway_to_analyse2.txt'), 
...
#lfc <- res_sign[,2] # res_sign from DE_analysis.R 
#names(lfc) <- row.names(res_sign)
